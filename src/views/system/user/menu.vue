  ...
  <div class="app-container">
    ...
    <el-header style="padding:0 0 0 0px;">
      <div class="filter-container">
        <el-input v-model="listQuery.username" prefix-icon="el-icon-search" style="width: 150px;" class="filter-item" placeholder="菜单名" clearable @keyup.enter.native="getRightList"/>
        <el-select v-model="listQuery.disabled" class="filter-item" style="width: 150px;" placeholder="菜单状态" clearable>
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column width="200px" align="center" label="菜单名">
        <template slot-scope="scope">
